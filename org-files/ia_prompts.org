...
#+end_src
*** COMMENT Extraer preguntas de un tema para primaria
...
#+begin_src txt
Actúa como un experto en pedagogía para primaria. Tu tarea es crear un cuestionario de 50 preguntas basado exclusivamente en los documentos proporcionados de la unidad 8.
Instrucciones críticas:
Formato JSON: Devuelve únicamente un código JSON que sea un array de objetos con esta estructura: {"id": número, "pregunta": "texto", "opciones": ["A", "B", "C", "D"], "respuestaCorrecta": índice del 0 al 3, "explicacion": "breve razón pedagógica"}.
...
Rigor Pedagógico: Las preguntas deben estar adaptadas a nivel de primaria. Cada explicacion debe basarse en el contenido de las fuentes.
Sin texto adicional: No incluyas preámbulos, conclusiones ni bibliografía. Solo el bloque de código JSON.
Citas: Asegúrate de que la lógica de las respuestas esté respaldada por la información de los materiales.
No incluyas en enunciados, respuestas o explicaciones enlaces a las fuentes.
#+end_src
