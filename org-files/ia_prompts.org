...
#+begin_src txt
Actúa como un experto en pedagogía para primaria. Tu tarea es crear un cuestionario de 50 preguntas basado exclusivamente en los documentos proporcionados en las fuentes activas.
...
No incluyas en tu respuesta enlaces a las fuentes.
#+end_src
